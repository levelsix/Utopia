...
public final class ProtocolsProto {
  ...
  public enum EventProtocolResponse
    ...
    S_LEVEL_UP_EVENT(13, 19),
    S_UPDATE_CLIENT_USER_EVENT(14, 20),
    ;
    ...
    private static final EventProtocolResponse[] VALUES = {
      S_CHAT_EVENT, S_BATTLE_EVENT, S_VAULT_EVENT, S_TASK_ACTION_EVENT, S_CLERIC_HEAL_EVENT, S_STARTUP_EVENT, S_RETRIEVE_TASKS_FOR_CITY_EVENT, S_RETRIEVE_QUESTS_FOR_CITY_EVENT, S_RETRIEVE_EQUIPS_FOR_ARMORY_EVENT, S_ARMORY_EVENT, S_IN_APP_PURCHASE_EVENT, S_RETRIEVE_CURRENT_MARKETPLACE_POSTS_EVENT, S_POST_TO_MARKETPLACE_EVENT, S_LEVEL_UP_EVENT, S_UPDATE_CLIENT_USER_EVENT, 
    };
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "_RETRIEVE_QUESTS_FOR_CITY_EVENT\020\007\022&\n\"S_R" +
      "ETRIEVE_EQUIPS_FOR_ARMORY_EVENT\020\010\022\022\n\016S_A" +
      ...
      "IENT_USER_EVENT\020\024B\020B\016ProtocolsProto"
    };
