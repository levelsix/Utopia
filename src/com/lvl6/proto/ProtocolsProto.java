...
public final class ProtocolsProto {
  ...
  public enum EventProtocolRequest
    ...
    C_STARTUP_EVENT(4, 5),
    C_RETRIEVE_TASKS_FOR_CITY_EVENT(5, 6),
    C_RETRIEVE_QUESTS_FOR_CITY_EVENT(6, 7),
    C_RETRIEVE_STATIC_DATA_FOR_SHOP_EVENT(7, 8),
    C_ARMORY_EVENT(8, 9),
    C_IN_APP_PURCHASE_EVENT(9, 10),
    C_RETRIEVE_CURRENT_MARKETPLACE_POSTS_EVENT(10, 11),
    C_POST_TO_MARKETPLACE_EVENT(11, 12),
    C_RETRACT_POST_FROM_MARKETPLACE_EVENT(12, 13),
    C_PURCHASE_FROM_MARKETPLACE_EVENT(13, 14),
    C_USE_SKILL_POINT_EVENT(14, 15),
    C_GENERATE_ATTACK_LIST_EVENT(15, 16),
    C_PURCHASE_NORM_STRUCTURE_EVENT(16, 17),
    C_MOVE_OR_ROTATE_NORM_STRUCTURE_EVENT(17, 18),
    C_SELL_NORM_STRUCTURE_EVENT(18, 19),
    C_UPGRADE_NORM_STRUCTURE_EVENT(19, 20),
    C_RETRIEVE_CURRENCY_FROM_NORM_STRUCTURE_EVENT(20, 21),
    C_REFILL_STAT_WITH_DIAMONDS_EVENT(21, 22),
    C_FINISH_NORM_STRUCT_WAITTIME_WITH_DIAMONDS_EVENT(22, 23),
    C_NORM_STRUCT_WAIT_COMPLETE_EVENT(23, 24),
    C_REDEEM_MARKETPLACE_EARNINGS_EVENT(24, 25),
    C_CRIT_STRUCTURE_ACTION_EVENT(25, 26),
    C_LOAD_PLAYER_CITY_EVENT(26, 27),
    C_RETRIEVE_STATIC_DATA_EVENT(27, 28),
    C_QUEST_ACCEPT_EVENT(28, 29),
    C_QUEST_LOG_DETAILS_EVENT(29, 30),
    C_QUEST_REDEEM_EVENT(30, 31),
    C_PURCHASE_CITY_EXPANSION_EVENT(31, 32),
    C_EXPANSION_WAIT_COMPLETE_EVENT(32, 33),
    C_REFILL_STAT_WAIT_COMPLETE_EVENT(33, 34),
    C_LEVEL_UP_EVENT(34, 35),
    C_ENABLE_APNS_EVENT(35, 36),
    C_PURCHASE_MARKETPLACE_LICENSE_EVENT(36, 37),
    C_USER_CREATE_EVENT(37, 38),
    C_EQUIP_EQUIPMENT_EVENT(38, 39),
    C_CHANGE_USER_LOCATION_EVENT(39, 40),
  ...
  public enum EventProtocolResponse
    ...
    S_STARTUP_EVENT(4, 5),
    S_RETRIEVE_TASKS_FOR_CITY_EVENT(5, 6),
    S_RETRIEVE_QUESTS_FOR_CITY_EVENT(6, 7),
    S_RETRIEVE_STATIC_DATA_FOR_SHOP_EVENT(7, 8),
    S_ARMORY_EVENT(8, 9),
    S_IN_APP_PURCHASE_EVENT(9, 10),
    S_RETRIEVE_CURRENT_MARKETPLACE_POSTS_EVENT(10, 11),
    S_POST_TO_MARKETPLACE_EVENT(11, 12),
    S_RETRACT_POST_FROM_MARKETPLACE_EVENT(12, 13),
    S_PURCHASE_FROM_MARKETPLACE_EVENT(13, 14),
    S_USE_SKILL_POINT_EVENT(14, 15),
    S_GENERATE_ATTACK_LIST_EVENT(15, 16),
    S_PURCHASE_NORM_STRUCTURE_EVENT(16, 17),
    S_MOVE_OR_ROTATE_NORM_STRUCTURE_EVENT(17, 18),
    S_SELL_NORM_STRUCTURE_EVENT(18, 19),
    S_UPGRADE_NORM_STRUCTURE_EVENT(19, 20),
    S_RETRIEVE_CURRENCY_FROM_NORM_STRUCTURE_EVENT(20, 21),
    S_REFILL_STAT_WITH_DIAMONDS_EVENT(21, 22),
    S_FINISH_NORM_STRUCT_WAITTIME_WITH_DIAMONDS_EVENT(22, 23),
    S_NORM_STRUCT_WAIT_COMPLETE_EVENT(23, 24),
    S_REDEEM_MARKETPLACE_EARNINGS_EVENT(24, 25),
    S_CRIT_STRUCTURE_ACTION_EVENT(25, 26),
    S_LOAD_PLAYER_CITY_EVENT(26, 27),
    S_RETRIEVE_STATIC_DATA_EVENT(27, 28),
    S_QUEST_ACCEPT_EVENT(28, 29),
    S_QUEST_LOG_DETAILS_EVENT(29, 30),
    S_QUEST_REDEEM_EVENT(30, 31),
    S_PURCHASE_CITY_EXPANSION_EVENT(31, 32),
    S_EXPANSION_WAIT_COMPLETE_EVENT(32, 33),
    S_REFILL_STAT_WAIT_COMPLETE_EVENT(33, 34),
    S_LEVEL_UP_EVENT(34, 35),
    S_ENABLE_APNS_EVENT(35, 36),
    S_PURCHASE_MARKETPLACE_LICENSE_EVENT(36, 37),
    S_USER_CREATE_EVENT(37, 38),
    S_EQUIP_EQUIPMENT_EVENT(38, 39),
    S_CHANGE_USER_LOCATION_EVENT(39, 40),
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "TARTUP_EVENT\020\005\022#\n\037C_RETRIEVE_TASKS_FOR_C" +
      "ITY_EVENT\020\006\022$\n C_RETRIEVE_QUESTS_FOR_CIT" +
      "Y_EVENT\020\007\022)\n%C_RETRIEVE_STATIC_DATA_FOR_" +
      ...
      "POINT_EVENT\020\017\022 \n\034C_GENERATE_ATTACK_LIST_" +
      "EVENT\020\020\022#\n\037C_PURCHASE_NORM_STRUCTURE_EVE" +
      "NT\020\021\022)\n%C_MOVE_OR_ROTATE_NORM_STRUCTURE_" +
      "EVENT\020\022\022\037\n\033C_SELL_NORM_STRUCTURE_EVENT\020\023" +
      "\022\"\n\036C_UPGRADE_NORM_STRUCTURE_EVENT\020\024\0221\n-" +
      "C_RETRIEVE_CURRENCY_FROM_NORM_STRUCTURE_" +
      "EVENT\020\025\022%\n!C_REFILL_STAT_WITH_DIAMONDS_E",
      "VENT\020\026\0225\n1C_FINISH_NORM_STRUCT_WAITTIME_" +
      "WITH_DIAMONDS_EVENT\020\027\022%\n!C_NORM_STRUCT_W" +
      "AIT_COMPLETE_EVENT\020\030\022\'\n#C_REDEEM_MARKETP" +
      "LACE_EARNINGS_EVENT\020\031\022!\n\035C_CRIT_STRUCTUR" +
      "E_ACTION_EVENT\020\032\022\034\n\030C_LOAD_PLAYER_CITY_E" +
      "VENT\020\033\022 \n\034C_RETRIEVE_STATIC_DATA_EVENT\020\034" +
      "\022\030\n\024C_QUEST_ACCEPT_EVENT\020\035\022\035\n\031C_QUEST_LO" +
      "G_DETAILS_EVENT\020\036\022\030\n\024C_QUEST_REDEEM_EVEN" +
      ...
      "C_LEVEL_UP_EVENT\020#\022\027\n\023C_ENABLE_APNS_EVEN" +
      "T\020$\022(\n$C_PURCHASE_MARKETPLACE_LICENSE_EV" +
      "ENT\020%\022\027\n\023C_USER_CREATE_EVENT\020&\022\033\n\027C_EQUI" +
      "P_EQUIPMENT_EVENT\020\'\022 \n\034C_CHANGE_USER_LOC" +
      "ATION_EVENT\020(\022\023\n\016A_ADMIN_UPDATE\020\254\002*\261\013\n\025E" +
      ...
      "\023S_TASK_ACTION_EVENT\020\003\022\023\n\017S_STARTUP_EVEN" +
      "T\020\005\022#\n\037S_RETRIEVE_TASKS_FOR_CITY_EVENT\020\006",
      ...
      "_ACCEPT_EVENT\020\035\022\035\n\031S_QUEST_LOG_DETAILS_E" +
      "VENT\020\036\022\030\n\024S_QUEST_REDEEM_EVENT\020\037\022#\n\037S_PU" +
      "RCHASE_CITY_EXPANSION_EVENT\020 \022#\n\037S_EXPAN" +
      "SION_WAIT_COMPLETE_EVENT\020!\022%\n!S_REFILL_S" +
      "TAT_WAIT_COMPLETE_EVENT\020\"\022\024\n\020S_LEVEL_UP_" +
      "EVENT\020#\022\027\n\023S_ENABLE_APNS_EVENT\020$\022(\n$S_PU" +
      "RCHASE_MARKETPLACE_LICENSE_EVENT\020%\022\027\n\023S_" +
      "USER_CREATE_EVENT\020&\022\033\n\027S_EQUIP_EQUIPMENT" +
      "_EVENT\020\'\022 \n\034S_CHANGE_USER_LOCATION_EVENT",
      "\020(\022\036\n\032S_UPDATE_CLIENT_USER_EVENT\0203\022\032\n\026S_" +
      "QUEST_COMPLETE_EVENT\0204\022\036\n\032S_REFERRAL_COD" +
      "E_USED_EVENT\0205B\020B\016ProtocolsProto"
    };
