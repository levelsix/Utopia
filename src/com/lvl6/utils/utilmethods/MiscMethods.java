...
public class MiscMethods {
  ...
  public static StartupConstants createStartupConstantsProto() {
    StartupConstants.Builder cb = StartupConstants.newBuilder()
        ...
        .setMinVaultLevel(ControllerConstants.MIN_LEVEL_FOR_VAULT)
        .setMinMarketplaceLevel(ControllerConstants.MIN_LEVEL_FOR_MARKETPLACE)
        .setMinArmoryLevel(ControllerConstants.MIN_LEVEL_FOR_ARMORY)
        .setMaxRankForCity(ControllerConstants.TASK_ACTION__MAX_CITY_RANK)
        ...
        .setMinutesForCityExpansion(ControllerConstants.EXPANSION_WAIT_COMPLETE__MINUTES_FOR_EXPANSION)
