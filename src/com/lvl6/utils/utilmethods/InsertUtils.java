...
public class InsertUtils {
  ...
  public static boolean insertAdcolonyRecentHistory(int userId, Timestamp timeOfReward, int diamondsEarned, 
      String digest) {
    Map <String, Object> insertParams = new HashMap<String, Object>();
  ...
  public static boolean insertKiipHistory(int userId, Timestamp clientTime,
    ...
    int numInserted = DBConnection.insertIntoTableBasic(DBConstants.TABLE_KIIP_REWARD_HISTORY, insertParams);
    if (numInserted == 1) {
      return true;
    }
    return false;
