...
public class ControllerConstants {
  ...
  public static final int RETRIEVE_CURRENT_MARKETPLACE_POSTS__EQUIP_ID_TO_POPULATE = 5;   //ANYONE SHOULD BE ABLE TO EQUIP, and should be cheap
  public static final int RETRIEVE_CURRENT_MARKETPLACE_POSTS__NUM_FAKE_TO_POPULATE = 2;   //ANYONE SHOULD BE ABLE TO EQUIP, and should be cheap
  public static final int RETRIEVE_CURRENT_MARKETPLACE_POSTS__FAKE_POSTER_ID = 2;
