...
public class ControllerConstants {
  ...
  public static final String USER_CREATE__FIRST_WALL_POST_TEXT = 
	  "Hi! My name's Andrew, one of the creators of this game. Feel free to message me if you need any help.";
...
//  public static final double LEVEL_UP_HEALTH_GAINED = 5.0;
  ...
  public static final int MIN_CLAN_MEMBERS_TO_HOLD_CLAN_TOWER = Globals.IS_SANDBOX() ? 2 : 25;//(Globals.KABAM_ENABLED() ? 25 : 20);
  ...
  public static final double ENHANCEMENT__COST_CONSTANT = 0.5;
