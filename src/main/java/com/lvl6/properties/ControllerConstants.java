...
public class ControllerConstants {
  ...
  public static final int STARTUP__CLAN_HOUSE_MIN_LEVEL = 8;
...
//  public static final double LEVEL_UP_HEALTH_GAINED = 5.0;
  ...
  public static final int[] ALL_CHARACTERS_WEAPON_ID_PER_LEVEL = 
    {1,1,1,124,124,      124,124,6,6,11,
    11,11,121,121,3,     201,137,19,19,139,
  ...
  public static final int[] ALL_CHARACTERS_ARMOR_ID_PER_LEVEL = 
    {41,41,41,160,160,   160,162,162,162,162,
    226,226,165,165,45,  169,169,169,67,67,
  ...
  public static final int[] ALL_CHARACTERS_EQUIP_LEVEL = 
    {250,250,250,251,251,251,254,254,255,255,
    252,252,256,256,256, 259,259,260,260,260,
...
//      "We have just added 40+ equips, a new city, and increased the level cap!"
  ...
  public static final int STARTUP__QUEST_ID_FOR_FIRST_LOSS_TUTORIAL = 325;
  public static final int[] STARTUP__QUEST_IDS_FOR_GUARANTEED_WIN = {324};
