...
public class NotificationConstants {
	...
	public static String CLAN_CONCEDED__SUBTITLE = "{1} now holds {2} and wants a stronger opponent. ";

	public static String CLAN_WON__TITLE = "{0} defeated {1} for possession of {2}!";
