...
public class NotificationConstants {
	...
	public static String CLAN_CONCEDED__TITLE = "Clan {0} forfeited the clan war to Clan {1}.";
	public static String CLAN_CONCEDED__SUBTITLE = "{1} now controls {2} and wants a stronger opponent. ";

	public static String CLAN_WON__TITLE = "Clan {0} defeated Clan {1} in the clan war for {2}!";
	public static String CLAN_WON__SUBTITLE = "{0} now controls {2} and is ready for another victim.";
	
	public static String CLAN_TOWER_ATTACKER_DETERMINED__TITLE = "Clan {0} declares war on Clan {1} for {2}!";
	
	public static String CLAN_TOWER_OWNER_DETERMINED__TITLE = "Clan {0} has claimed ownership of {1}.";
