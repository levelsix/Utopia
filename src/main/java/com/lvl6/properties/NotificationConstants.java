...
public class NotificationConstants {
  ...
  public static String CLAN_TOWER_ATTACKER_DETERMINED__SUBTITLE = "The winner will be determined in 6 hours!";
	...
	public static String CLAN_TOWER_DISTRIBUTE_REWARDS__TITLE = "Your clan has just been awarded gold!";
	public static String CLAN_TOWER_DISTRIBUTE_REWARDS__SUBTITLE = "Maintain the tower for 24 more hours to receive more!";
