...
public final class ProtocolsProto {
  ...
  public enum EventProtocolRequest
    ...
    C_LOGOUT_EVENT(76, 101),
    A_ADMIN_UPDATE(77, 300),
    ;
  ...
  public enum EventProtocolResponse
    ...
    S_UPDATE_CLIENT_USER_EVENT(77, 101),
    S_QUEST_COMPLETE_EVENT(78, 102),
    S_REFERRAL_CODE_USED_EVENT(79, 103),
    S_PURGE_STATIC_DATA_EVENT(80, 104),
    S_RECEIVED_GROUP_CHAT_EVENT(81, 105),
    S_SEND_ADMIN_MESSAGE_EVENT(82, 106),
    S_GENERAL_NOTIFICATION_EVENT(83, 107),
    ;
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "_COLLECT_EQUIP_ENHANCEMENT_EVENT\020O\022\022\n\016C_" +
      "LOGOUT_EVENT\020e\022\023\n\016A_ADMIN_UPDATE\020\254\002*\236\026\n\025" +
      ...
      "IP_ENHANCEMENT_EVENT\020O\022\036\n\032S_UPDATE_CLIEN" +
