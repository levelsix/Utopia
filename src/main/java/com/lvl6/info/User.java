...
public class User implements Serializable {
	...
	public User(int id, String name, int level, UserType type, int attack,
			...
			Date lastEnergyRefillTime, int skillPoints, int healthMax,
			...
			String deviceToken, Date lastBattleNotificationTime,
			Date lastTimeAttacked, int numBadges,
	...
	public boolean updateAbsoluteUserLocation(Location location) {
		...
		absoluteParams
				.put(DBConstants.USER__LONGITUDE, location.getLongitude());
	...
	public boolean updateEquipped(UserEquip ue) {
		...
		Equipment equipment = EquipmentRetrieveUtils
				.getEquipmentIdsToEquipment().get(ue.getEquipId());

		Map<String, Object> absoluteParams = new HashMap<String, Object>();
		if (equipment.getType() == EquipType.WEAPON) {
			absoluteParams.put(DBConstants.USER__WEAPON_EQUIPPED_USER_EQUIP_ID,
					userEquipId);
		}
		if (equipment.getType() == EquipType.ARMOR) {
			absoluteParams.put(DBConstants.USER__ARMOR_EQUIPPED_USER_EQUIP_ID,
					userEquipId);
		}
		if (equipment.getType() == EquipType.AMULET) {
			absoluteParams.put(DBConstants.USER__AMULET_EQUIPPED_USER_EQUIP_ID,
					userEquipId);
		}
	...
	public boolean updateAbsoluteAllEquipped(int weaponEquippedUserEquipId,
		...
		Map<String, Object> absoluteParams = new HashMap<String, Object>();
		absoluteParams.put(DBConstants.USER__WEAPON_EQUIPPED_USER_EQUIP_ID,
				weaponEquippedUserEquipId);
		absoluteParams.put(DBConstants.USER__ARMOR_EQUIPPED_USER_EQUIP_ID,
				armorEquippedUserEquipId);
		absoluteParams.put(DBConstants.USER__AMULET_EQUIPPED_USER_EQUIP_ID,
				amuletEquippedUserequipId);
	...
	public boolean updateUnequip(boolean isWeapon, boolean isArmor,
			boolean isAmulet) {
		Map<String, Object> conditionParams = new HashMap<String, Object>();
		conditionParams.put(DBConstants.USER__ID, id);
	...
	public boolean updateRelativeDiamondsAbsoluteLastshortlicensepurchasetimeLastlonglicensepurchasetime(
			int diamondChange, Timestamp lastShortLicensePurchaseTime,
			Timestamp lastLongLicensePurchaseTime) {
		Map<String, Object> conditionParams = new HashMap<String, Object>();
		conditionParams.put(DBConstants.USER__ID, id);
		...
		if (lastShortLicensePurchaseTime != null) {
			absoluteParams.put(
					DBConstants.USER__LAST_SHORT_LICENSE_PURCHASE_TIME,
					lastShortLicensePurchaseTime);
		}
		if (lastLongLicensePurchaseTime != null) {
			absoluteParams.put(
					DBConstants.USER__LAST_LONG_LICENSE_PURCHASE_TIME,
	...
	public boolean updateRelativeBadgeAbsoluteLastbattlenotificationtime(
			int badgeChange, Timestamp newLastBattleNotificationTime) {
		Map<String, Object> conditionParams = new HashMap<String, Object>();
		conditionParams.put(DBConstants.USER__ID, id);

		Map<String, Object> absoluteParams = new HashMap<String, Object>();
		absoluteParams.put(DBConstants.USER__LAST_BATTLE_NOTIFICATION_TIME,
				newLastBattleNotificationTime);
	...
	public boolean updateAbsoluteApsalaridLastloginBadges(String newApsalarId,
			Timestamp loginTime, int newBadges) {
		Map<String, Object> conditionParams = new HashMap<String, Object>();
		conditionParams.put(DBConstants.USER__ID, id);
	 ...
	 */
	public boolean updateLaststaminarefilltimeStaminaIslaststaminastatefull(
			Timestamp lastStaminaRefillTime, int staminaChange) {
		Map<String, Object> conditionParams = new HashMap<String, Object>();
		conditionParams.put(DBConstants.USER__ID, id);

		Map<String, Object> absoluteParams = new HashMap<String, Object>();
		absoluteParams.put(DBConstants.USER__LAST_STAMINA_REFILL_TIME,
				lastStaminaRefillTime);
	 ...
	 */
	public boolean updateLastenergyrefilltimeEnergy(
			Timestamp lastEnergyRefillTime, int energyChange) {
		Map<String, Object> conditionParams = new HashMap<String, Object>();
		conditionParams.put(DBConstants.USER__ID, id);

		Map<String, Object> absoluteParams = new HashMap<String, Object>();
		absoluteParams.put(DBConstants.USER__LAST_ENERGY_REFILL_TIME,
	 ...
	 */
	public boolean updateRelativeDiamondsRestoreStat(int diamondChange,
			StatType statType) {
		Map<String, Object> conditionParams = new HashMap<String, Object>();
		conditionParams.put(DBConstants.USER__ID, id);
	 ...
	 */
	public boolean updateAbsoluteRestoreEnergyStaminaRelativeUpdateSkillPoints(
			int skillPointsChange, Timestamp levelUpTime) {
		Map<String, Object> conditionParams = new HashMap<String, Object>();
		conditionParams.put(DBConstants.USER__ID, id);
		...
		if (skillPointsChange > 0) {
			...
			relativeParams.put(DBConstants.USER__SKILL_POINTS,
					skillPointsChange);
		}
	...
	public boolean updateRelativeEnergyEnergymaxHealthmaxStaminaStaminamaxSkillPoints(
		...
		if (energyChange > 0)
			relativeParams.put(DBConstants.USER__ENERGY, energyChange);
		if (energyMaxChange > 0)
			relativeParams.put(DBConstants.USER__ENERGY_MAX, energyMaxChange);
		if (healthMaxChange > 0)
			relativeParams.put(DBConstants.USER__HEALTH_MAX, healthMaxChange);
		if (staminaChange > 0)
			relativeParams.put(DBConstants.USER__STAMINA, staminaChange);
		if (staminaMaxChange > 0)
			relativeParams.put(DBConstants.USER__STAMINA_MAX, staminaMaxChange);
	 ...
	 * used for using skill points
	 */
	public boolean updateRelativeAttackDefenseSkillPoints(int attackChange,
			int defenseChange, int skillPointsChange) {
		Map<String, Object> conditionParams = new HashMap<String, Object>();
		conditionParams.put(DBConstants.USER__ID, id);
	 ...
	 */
	public boolean updateRelativeDiamondsCoinsExperienceNaive(
			int diamondChange, int coinChange, int experienceChange) {
		Map<String, Object> conditionParams = new HashMap<String, Object>();
		conditionParams.put(DBConstants.USER__ID, id);
	...
	public boolean updateMoveMarketplaceEarningsToRealStatResetNummarketplacesalesunredeemed() {
		...
		relativeParams.put(DBConstants.USER__DIAMONDS,
		...
		absoluteParams.put(DBConstants.USER__NUM_MARKETPLACE_SALES_UNREDEEMED,
				0);
	...
	public boolean updateRelativeDiamondsearningsCoinsearningsNumpostsinmarketplaceNummarketplacesalesunredeemedNaive(
			...
			int numMarketplaceSalesUnredeemedChange) {
		Map<String, Object> conditionParams = new HashMap<String, Object>();
		conditionParams.put(DBConstants.USER__ID, id);

		Map<String, Object> relativeParams = new HashMap<String, Object>();

		relativeParams.put(DBConstants.USER__MARKETPLACE_DIAMONDS_EARNINGS,
				diamondEarningsChange);
		relativeParams.put(DBConstants.USER__MARKETPLACE_COINS_EARNINGS,
				coinEarningsChange);
		relativeParams.put(DBConstants.USER__NUM_POSTS_IN_MARKETPLACE,
				numPostsInMarketplaceChange);
		relativeParams.put(DBConstants.USER__NUM_MARKETPLACE_SALES_UNREDEEMED,
				numMarketplaceSalesUnredeemedChange);
	 ...
	 */
	public boolean updateRelativeDiamondsCoinsNumpostsinmarketplaceNaive(
			int diamondChange, int coinChange, int numPostsInMarketplaceChange) {
		Map<String, Object> conditionParams = new HashMap<String, Object>();
		conditionParams.put(DBConstants.USER__ID, id);
	...
	/*
	 * used for tasks * user- coins/exp/tasks_completed increase, energy
	 * decrease
	 */
	public boolean updateRelativeCoinsExpTaskscompletedEnergySimulateenergyrefill(
		...
		relativeParams.put(DBConstants.USER__TASKS_COMPLETED,
	...
	public boolean updateRelativeCoinsNumreferrals(int coinChange,
			int numReferralsChange) {
		Map<String, Object> conditionParams = new HashMap<String, Object>();
		conditionParams.put(DBConstants.USER__ID, id);
		...
		if (numReferralsChange != 0) {
			relativeParams.put(DBConstants.USER__NUM_REFERRALS,
					numReferralsChange);
		}
	...
	public boolean updateRelativeCoinsCoinsretrievedfromstructs(int coinChange) {
		...
		if (coinChange != 0) {
			relativeParams.put(DBConstants.USER__COINS, coinChange);
			relativeParams.put(
					DBConstants.USER__NUM_COINS_RETRIEVED_FROM_STRUCTS,
					coinChange);
		}
	...
	public boolean updateRelativeCoinsVault(int coinsChange, int vaultChange) {
		...
		Map<String, Object> relativeParams = new HashMap<String, Object>();
		if (coinsChange != 0)
			relativeParams.put(DBConstants.USER__COINS, coinsChange);
		if (vaultChange != 0)
	...
	public boolean updateRelativeStaminaExperienceCoinsBattleswonBattleslostFleesSimulatestaminarefill(
			int stamina, int experience, int coins, int battlesWon,
			int battlesLost, int fleesChange, boolean simulateStaminaRefill,
			boolean updateLastAttackedTime, Timestamp clientTime) {
		Map<String, Object> conditionParams = new HashMap<String, Object>();
		conditionParams.put(DBConstants.USER__ID, id);

		Map<String, Object> relativeParams = new HashMap<String, Object>();
		if (stamina != 0)
			relativeParams.put(DBConstants.USER__STAMINA, stamina);
		if (experience != 0)
			relativeParams.put(DBConstants.USER__EXPERIENCE, experience);
		if (coins != 0)
			relativeParams.put(DBConstants.USER__COINS, coins);
		if (battlesWon != 0)
		...
		if (updateLastAttackedTime) {
			absoluteParams
					.put(DBConstants.USER__LAST_TIME_ATTACKED, clientTime);
		}
		if (absoluteParams.size() == 0) {
			absoluteParams = null;
		}
	...
	public boolean updateRelativeDiamondsForFree(int diamondChange,
		...
		if (freeDiamondsType == EarnFreeDiamondsType.ADCOLONY) {
			relativeParams
					.put(DBConstants.USER__NUM_ADCOLONY_VIDEOS_WATCHED, 1);
		}
