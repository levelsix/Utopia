...
public class PlayerWallPost implements Serializable {
	private static final long serialVersionUID = -1405235869055550834L;
	private int id;
	...
	public PlayerWallPost(int id, int posterId, int wallOwnerId,
