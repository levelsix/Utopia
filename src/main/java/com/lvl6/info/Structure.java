...
public class Structure implements Serializable {
	...
	private static final long serialVersionUID = -5355525505077434822L;
	private int id;
	private String name;
	private int income;
	...
	public Structure(int id, String name, int income, int minutesToGain,
			int minutesToBuild, int minutesToUpgradeBase, int coinPrice,
			int diamondPrice, int minLevel, int xLength, int yLength,
			int instaBuildDiamondCost, int instaRetrieveDiamondCostBase,
	...
	public String toString() {
		return "Structure [id=" + id + ", name=" + name + ", income=" + income
				...
				+ minutesToBuild + ", minutesToUpgradeBase="
				+ minutesToUpgradeBase + ", coinPrice=" + coinPrice
				+ ", diamondPrice=" + diamondPrice + ", minLevel=" + minLevel
				+ ", xLength=" + xLength + ", yLength=" + yLength
				+ ", instaBuildDiamondCost=" + instaBuildDiamondCost
				+ ", instaRetrieveDiamondCostBase="
				+ instaRetrieveDiamondCostBase
				+ ", instaUpgradeDiamondCostBase="
				+ instaUpgradeDiamondCostBase + ", xOffset="
